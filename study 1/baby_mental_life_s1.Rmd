...
In the end, we ended up with a sample of 301 participants who passed our attention checks.
...
```{r}
efa_00mo_par <- fa(d_00mo, nfactors = reten_00mo_par, rotate = "oblimin",
                  scores = "tenBerge", impute = "median")
```
...
```{r}
efa_00mo_bic <- fa(d_00mo, nfactors = reten_00mo_bic, rotate = "oblimin",
                   scores = "tenBerge", impute = "median")
```
...
```{r}
efa_00mo_k <- fa(d_00mo, nfactors = reten_00mo_k, rotate = "oblimin",
                 scores = "tenBerge", impute = "median")
```
...
```{r}
efa_09mo_par <- fa(d_09mo, nfactors = reten_09mo_par, rotate = "oblimin",
                   scores = "tenBerge", impute = "median")
```
...
```{r}
efa_09mo_bic <- fa(d_09mo, nfactors = reten_09mo_bic, rotate = "oblimin",
                   scores = "tenBerge", impute = "median")
```
...
```{r}
efa_09mo_k <- fa(d_09mo, nfactors = reten_09mo_k, rotate = "oblimin",
                 scores = "tenBerge", impute = "median")
```
...
```{r}
efa_60mo_par <- fa(d_60mo, nfactors = reten_60mo_par, rotate = "oblimin",
                   scores = "tenBerge", impute = "median")
```
...
```{r}
efa_60mo_bic <- fa(d_60mo, nfactors = reten_60mo_bic, rotate = "oblimin",
                   scores = "tenBerge", impute = "median")
```
...
```{r}
efa_60mo_k <- fa(d_60mo, nfactors = reten_60mo_k, rotate = "oblimin",
                 scores = "tenBerge", impute = "median")
```
